...
class Mesh(object):
    ...
    def __init__(self, city, size):
        getcontext().prec = 8
        if size == '4000m':
            self.dLon = Decimal('0.04')
            self.dLat = Decimal('0.032')
        elif size == '2000m':
            self.dLon = Decimal('0.02')
            self.dLat = Decimal('0.016')
        elif size == '1000m':
            self.dLon = Decimal('0.01')
            self.dLat = Decimal('0.008')
        elif size == '500m':
            self.dLon = Decimal('0.005')
            self.dLat = Decimal('0.004')
        elif size == '250m':
            self.dLon = Decimal('0.0025')
            self.dLat = Decimal('0.002')
        elif size == '100m':
            self.dLon = Decimal('0.001')
            self.dLat = Decimal('0.0008')
        else:
        ...
        if city == 'tokyo':
            self.minLon = Decimal('139.5')
            self.maxLon = Decimal('139.9')
            self.minLat = Decimal('35.5')
            self.maxLat = Decimal('35.82')
        elif city == 'osaka':
            self.minLon = Decimal('135.3')
            self.maxLon = Decimal('135.7')
            self.minLat = Decimal('34.5')
            self.maxLat = Decimal('34.82')
        elif city == 'nagoya':
            self.minLon = Decimal('136.7')
            self.maxLon = Decimal('137.1')
            self.minLat = Decimal('35.0')
            self.maxLat = Decimal('35.3')
        else:
            print('invalid city name...')
            assert False
